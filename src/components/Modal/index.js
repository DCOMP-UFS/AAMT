...
export default function Modal({ id, title, ...props }) {
  ...
  return(
    //Modals agora são static, ou seja, não fecham caso o usuario clique fora do contorno dele
    //o que faz ele tem esse comportamento é a propiedade: data-backdrop={ "static" }
    <div id={ id } className="modal fade show" role="dialog"  data-backdrop={ "static" } >
