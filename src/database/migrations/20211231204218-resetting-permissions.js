...
module.exports = {
  up: async ( queryInterface, Sequelize ) => {    
    ...
    const [ coodGeralFuncoes ]    = await queryInterface.sequelize.query( "SELECT * FROM funcoes WHERE nome IN ( 'relatorio_por_atividade_regional', 'definir_ciclo', 'manter_municipio', 'manter_usuario', 'manter_atividade' );" );
