...
import { 
  ...
  situacao_imovel_enum, 
  situacao_imovel2_enum, 
  situacao_deposito_enum, 
  situacao_vistoria_enum 
            ...
            <article className="p-0">
              <div className="card">
                ...
                <Row>
                  ...
                  <Col md="12">
                    <small><b>Tratado</b> - imóveis com ao menos 1 deposito tratado adicionado na vistoria</small>
                  </Col>
                </Row>
              </div>
            </article>
