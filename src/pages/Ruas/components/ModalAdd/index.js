...
// ACTIONS 
import { clearStreetExist, createStreetRequest, clearCreate } from '../../../../store/Rua/ruaActions';
...
const ModalAddRua = ({id, show, handleClose, ...props }) => {
   ...
   * Caso seja verdadeiro, é feito uma requisição criar nova rua
   * 
  ...
  const handleSubmit = e => {
    ...
    if(!nomeInvalido && !cepInvalido){
      ...
      setFlLoading(true)
      props.createStreetRequest(nomeNovoLogradouro, cepSemMascara, props.municipio.id)
    }
