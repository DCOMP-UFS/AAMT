...
function Usuarios({ municipio_id, usuarios, ...props }) {
  ...
  const options = {
    ...
    onRowClick: (row, ...props) => {
      ...
      window.location = `${ window.location.origin.toString() }/coord/usuarios/${ id }`;
    }
  };
...
const mapDispatchToProps = dispatch =>
  bindActionCreators({ changeSidebar, getUsersByCityRequest, clearToast, changeUserEditIndex, changeTableSelected }, dispatch);
