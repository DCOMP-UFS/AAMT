...
export const getOpenAndFinishedCyclesRequest = regionalSaude_id => {
  return {
    type: ActionTypes.GET_OPEN_AND_FINISHED_CYCLES_REQUEST,
    payload: {
      regionalSaude_id
    }
  }
...
export const getOpenAndFinishedCyclesSuccess = ciclos => {
  return {
    type: ActionTypes.GET_OPEN_AND_FINISHED_CYCLES_SUCCESS,
    payload: {
      ciclos
    }
  }
